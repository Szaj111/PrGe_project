    ...
    <div className="about">
      ...
      <div className="web_side_ch">
        ...
        <div className="text">
          ...
          vel nisi tellus. Donec enim odio, semper ut justo non, finibus
          dignissim nulla. Proin non tincidunt nibh, ac finibus mi. Vestibulum
          ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia
          curae; Phasellus convallis convallis libero vel tincidunt. Suspendisse
          congue eget lectus a ornare. Pellentesque dapibus, odio eu interdum
          volutpat, ex ante auctor augue, ac volutpat massa justo at neque.
          Vestibulum pretium eros a metus tempor vulputate. Integer eu ex non
          orci fermentum venenatis id eget urna. Aenean aliquet condimentum
          suscipit. Etiam auctor nec arcu sit amet consequat. Curabitur sit amet
          arcu vitae nulla tristique scelerisque. Morbi ac magna aliquam,
          dapibus mi non, facilisis risus. Ut in massa imperdiet mauris faucibus
          scelerisque a fermentum enim. Phasellus interdum mattis consectetur.
          Nullam molestie tristique ipsum eget ultricies. Duis mattis, ex nec
          rutrum elementum, dolor felis bibendum nunc, eu rutrum odio felis eu
          libero. Cras sagittis, diam eu porttitor consectetur, mi massa
          molestie nisl, consectetur efficitur eros lectus vitae dui. Curabitur
          consequat turpis et mi fringilla commodo. Orci varius natoque
          penatibus et magnis dis parturient montes, nascetur ridiculus mus.
          Aenean varius sit amet neque at elementum. Fusce et tincidunt elit, ut
          eleifend nunc. Nullam fermentum enim et mattis condimentum. Ut nunc
          metus, laoreet vitae iaculis sed, bibendum ut nibh. Etiam nec
          vestibulum sem. Cras a velit at diam mattis gravida tristique eu nunc.
          Nam a dictum justo, ut pretium magna. Curabitur in laoreet sem, id
          iaculis erat.
        </div>
      </div>
      ;
